...
def write_to_csv(imu,time_frame,previous_time):
    global flag
    path = "/home/dhirajsinh/Fusion_lab/clarius/listener/src/python/data/imu_data.csv"
...
def newProcessedImage(image, width, height, bpp, micronsPerPixel, timestamp, imu):
    ...
    path_img = "/home/dhirajsinh/Fusion_lab/clarius/listener/src/python/data/" + f"{time_frame}.png"
